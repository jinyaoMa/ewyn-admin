CREATE DATABASE  IF NOT EXISTS `ewyn0` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `ewyn0`;
...
CREATE TABLE `customer` (
  ...
  `start_weight` decimal(10,0) NOT NULL,
...
INSERT INTO `customer` VALUES (1,'Jason','Wang','1231231234','2021-12-31','abc@abc.com','xxx...','2020-12-31',321,123,1,2,2,1),(2,'Mark','Ma','3213214321','2022-01-01','def@def.com','xyzabcdef','2019-09-19',213,132,5,1,3,1),(3,'Test','Robot','1112223333','2021-12-31','abc@zxy.com','xxx...abc','2020-12-31',456,312,1,1,2,1);
...
CREATE TABLE `measurement` (
  ...
  `weight` decimal(10,0) NOT NULL,
  `bust_chest` decimal(10,0) NOT NULL,
  `waist` decimal(10,0) NOT NULL,
  `mid_section` decimal(10,0) NOT NULL,
  `hips` decimal(10,0) NOT NULL,
  `right_arm` decimal(10,0) NOT NULL,
  `right_thigh` decimal(10,0) NOT NULL,
  `total_inches` decimal(10,0) DEFAULT NULL,
  `inches_lost_to_date` decimal(10,0) DEFAULT NULL,
  `customerid` int(11) NOT NULL,
...
INSERT INTO `measurement` VALUES (1,'2020-12-15','abc',123,3,0,0,0,0,0,NULL,NULL,1);
